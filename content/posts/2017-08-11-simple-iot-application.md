...
![Overview](/posts/iot-application/simple-iot-application-overview.svg)
...
![REST settings example](/posts/iot-application/iot-rest-example.png)
...
![SQLite database example](/posts/iot-application/iot-sqlite-db.png)
...
![Application output](/posts/iot-application/iot-app-output.png)

Complete application with all the code is available for
[download](/posts/iot-application/simple-iot-application.zip).
